...
public class Main extends GridPane{
	...
	private static void init() {
		...
		if(combinations == null){
			...
			combinations.add(new Combination("Test", new Gesture[]{Gesture.PUNCH, Gesture.PUNCH, Gesture.PUNCH, Gesture.UPPERCUT, Gesture.HOOK, Gesture.PUNCH, Gesture.PUNCH, Gesture.PUNCH}));
		}
		if(usernames == null){
